...
`LOGO` VARCHAR(1000) NOT NULL DEFAULT 'https://pic3.zhimg.com/50/v2-e2361d82ce7465808260f87bed4a32d0_qhd.jpg',
PRIMARY KEY(`BID`)
...
`HEAD_PORTRAIT` VARCHAR(1000) NOT NULL DEFAULT 'https://pic3.zhimg.com/50/v2-e2361d82ce7465808260f87bed4a32d0_qhd.jpg',
...
('美食', 'http://qdnhdgyix.bkt.clouddn.com/777'),
('书籍', 'http://qdnhdgyix.bkt.clouddn.com/222'),
('体育', 'http://qdnhdgyix.bkt.clouddn.com/333'),
('财经', 'http://qdnhdgyix.bkt.clouddn.com/444'),
('政治', 'http://qdnhdgyix.bkt.clouddn.com/555'),
('学习', 'http://qdnhdgyix.bkt.clouddn.com/666');
...
('狗管理一号', SHA1('12345678'), '1146186018@qq.com', 'http://qdnhdgyix.bkt.clouddn.com/222', 1, 'Y', 'QWER', '虽千万人吾亦往矣', 2, 2),
('狗管理二号', SHA1('87654321'), '814384981@qq.com', 'http://qdnhdgyix.bkt.clouddn.com/333', 1, 'Y', 'tyui', '海不邀我自来也！！！', 2, 1),
('贾丁', SHA1('qwertyui'), '814384981@qq.com', 'http://qdnhdgyix.bkt.clouddn.com/444', 0, 'Y', '1284', '别和我闹了', 2, 3),
('毕展语', SHA1('11111111'), '814384981@qq.com', 'https://pic3.zhimg.com/50/v2-e2361d82ce7465808260f87bed4a32d0_qhd.jpg', 0, 'Y', '1k4g', '让我们一起大喊——666！', 2, 3),
('李泽宇', SHA1('12345679'), '814384981@qq.com', 'https://pic3.zhimg.com/50/v2-e2361d82ce7465808260f87bed4a32d0_qhd.jpg', 0, 'N', 's8cr', '海上升明月', 0, 0);
